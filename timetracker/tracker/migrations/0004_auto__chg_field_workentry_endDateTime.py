...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkEntry.endDateTime'
        db.alter_column(u'tracker_workentry', 'endDateTime', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'WorkEntry.endDateTime'
        db.alter_column(u'tracker_workentry', 'endDateTime', self.gf('django.db.models.fields.DateTimeField')(default=''))
